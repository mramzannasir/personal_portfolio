...
const Project = () => {
	return (
		<>
			<div id="Project" className="wrapper mt-[8rem]">
				<div className="flex sas w-full flex-col items-center justify-center">
				...
				<p className="btn3 mt-[5rem] flex cursor-pointer items-center justify-center text-center text-lg ">
